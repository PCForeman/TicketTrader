...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sell__ = __webpack_require__(659);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_path__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angularfire2_storage__ = __webpack_require__(349);
...
var SellPage = /** @class */ (function () {
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            _this.PayoutAccount = accNoPlainText;
                                            _this.PayoutSortCode = sortCodePlainText;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        artist = this.listing.Name.toUpperCase();
                    ...
                    case 8:
                        ...
                        this.afAuth.authState.take(1).subscribe(function (auth) {
                            _this.afDatabase
                                ...
                                _this.listing.PaySortCode = _this.PayoutSortCode;
                                _this.listing.Price = price;
                                _this.listing.PayoutAccount = _this.PayoutAccount;
                                _this.listing.Name = artist;
                                _this.listing.Time = startTime;
    ...
    SellPage.prototype.ticketTraderInfo = function () {
        var myModalOpts = {
            cssClass: "modal",
    ...
    SellPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-sell",template:/*ion-inline-start:"C:\Users\paulf\Desktop\TicketTrader\TicketTrader\src\pages\sell\sell.html"*/'<ion-header>\n\n  <ion-navbar hideBackButton="true" color="midnight-blue">\n\n    <ion-buttons right>\n\n      <button ion-button icon-only color="light" (click)="ticketTraderInfo()">\n\n        <ion-icon name="information-circle"></ion-icon>\n\n      </button>\n\n      <button ion-button icon-only color="light" (click)="logout()">\n\n        <ion-icon name="log-out"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-buttons left>\n\n      <button ion-button icon-only color="light" (click)="checkOut()">\n\n        <ion-icon name="basket"></ion-icon>\n\n      </button>\n\n      <button ion-button icon-only color="light" (click)="orderHistory()">\n\n        <ion-icon name="cloud-download"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title position text-center>Sell Tickets</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n  <div class="ngDivAccount">\n\n    <ion-list-header text-center>List a ticket</ion-list-header>\n\n\n\n    <ion-item>\n\n      <ion-label floating>Account number to pay</ion-label>\n\n      <ion-input id="txtTime" [(ngModel)]="PayoutAccount"></ion-input>\n\n    </ion-item>\n\n\n\n    <ion-item>\n\n      <ion-label floating>Sort code</ion-label>\n\n      <ion-input id="txtTime" [(ngModel)]="PayoutSortCode"></ion-input>\n\n    </ion-item>\n\n\n\n    <ion-item>\n\n      <ion-label floating>Artist(s)</ion-label>\n\n      <ion-input id="txtEvent" [(ngModel)]="listing.Name"></ion-input>\n\n    </ion-item>\n\n\n\n    <ion-item>\n\n      <ion-label floating>Start time (24.00 Hr)</ion-label>\n\n      <ion-input id="txtTime" [(ngModel)]="listing.Time"></ion-input>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label floating>Date of event</ion-label>\n\n      <ion-datetime\n\n        id="listingDate"\n\n        displayFormat="DD/MM/YY"\n\n        min="2019-05-22"\n\n        max="2020-05-22"\n\n        [(ngModel)]="listing.Date"\n\n      ></ion-datetime>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label floating>Price £1-50</ion-label>\n\n      <ion-input id="txtPrice" [(ngModel)]="listing.Price"></ion-input>\n\n      <button\n\n        ion-button\n\n        id="btnCheckPrice"\n\n        icon-only\n\n        class="calcButton"\n\n        color="midnight-blue"\n\n        (click)="ticketIncomeCalc()"\n\n        item-end\n\n      >\n\n      <ion-icon name="calculator"></ion-icon>\n\n      </button>\n\n    </ion-item>\n\n    <p>\n\n      <button\n\n        class="iconButtons"\n\n        ion-button\n\n        id="btnLocation"\n\n        icon-only\n\n        position="text-center"\n\n        (click)="findVenue()"\n\n        color="midnight-blue"\n\n      >\n\n        <ion-icon name="search"></ion-icon>Venue\n\n      </button>\n\n\n\n      <button\n\n        ion-button\n\n        class="iconButtons"\n\n        id="btnUploadTicket"\n\n        icon-only\n\n        position="text-center"\n\n        color="midnight-blue"\n\n        (click)="selectTicket()"\n\n      >\n\n        <ion-icon name="cloud-upload"></ion-icon>Ticket\n\n      </button>\n\n      <br />\n\n      <button\n\n        class="createListingButton"\n\n        ion-button\n\n        block\n\n        position="text-center"\n\n        color="midnight-blue"\n\n        id="btnCreateListing"\n\n        (click)="createListingConfirmation()"\n\n      >\n\n        Confirm listing\n\n      </button>\n\n    </p>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\paulf\Desktop\TicketTrader\TicketTrader\src\pages\sell\sell.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__["AngularFireAuth"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__["AngularFireAuth"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ToastController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3_angularfire2_database__["AngularFireDatabase"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angularfire2_database__["AngularFireDatabase"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ModalController */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _j || Object, typeof (_k = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_native_aes_256___["a" /* AES256 */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_native_aes_256___["a" /* AES256 */]) === "function" && _k || Object, typeof (_l = typeof __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__["a" /* File */]) === "function" && _l || Object, typeof (_m = typeof __WEBPACK_IMPORTED_MODULE_8_angularfire2_storage__["AngularFireStorage"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8_angularfire2_storage__["AngularFireStorage"]) === "function" && _m || Object, typeof (_o = typeof __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_path__["a" /* FilePath */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__ionic_native_file_path__["a" /* FilePath */]) === "function" && _o || Object, typeof (_p = typeof __WEBPACK_IMPORTED_MODULE_5__ionic_native_android_permissions___["a" /* AndroidPermissions */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__ionic_native_android_permissions___["a" /* AndroidPermissions */]) === "function" && _p || Object])
    ], SellPage);
    return SellPage;
