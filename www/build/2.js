...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__payment_modal__ = __webpack_require__(539);
...
var PaymentModalPage = /** @class */ (function () {
    function PaymentModalPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    PaymentModalPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PaymentModalPage');
    };
    PaymentModalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-payment-modal',template:/*ion-inline-start:"C:\Users\paulf\Desktop\TicketTrader Master - Copy\prco304-final-year-project-PCForeman\src\pages\payment-modal\payment-modal.html"*/'<ion-header>\n  <ion-navbar color="midnight-blue">\n    <ion-buttons end>\n      <button ion-button (click)="close()">Close</button>\n    </ion-buttons>\n    <ion-title>Checkout</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n<ion-item>\n<ion-label position text-center>Name on card</ion-label>\n</ion-item>\n<ion-item>\n<ion-input position text-center></ion-input>\n</ion-item>\n\n<ion-item>\n    <ion-label position text-center>16 Digit card number</ion-label>\n    </ion-item>\n    <ion-item>\n    <ion-input position text-center></ion-input>\n    </ion-item>\n\n    <ion-item>\n        <ion-label position text-center>Expiry date</ion-label>\n        </ion-item>\n        <ion-item>\n        <ion-input id ="input" position text-center></ion-input>\n        </ion-item>\n\n        <ion-item>\n            <ion-label position text-center>CVC</ion-label>\n            </ion-item>\n            <ion-item>\n            <ion-input position text-center></ion-input>\n            </ion-item>\n\n            <button position="text-center" ion-button>{{listingData.price}}</button>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\paulf\Desktop\TicketTrader Master - Copy\prco304-final-year-project-PCForeman\src\pages\payment-modal\payment-modal.html"*/,
        }),
